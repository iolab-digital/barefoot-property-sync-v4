...
* **Error Handling**: Graceful handling of SOAP extension issues and API errors
...
3. If you see a SOAP extension error, contact your hosting provider to enable PHP SOAP extension.
...
= I get a SOAP extension error when activating =

This plugin requires the PHP SOAP extension to communicate with Barefoot's API. Contact your hosting provider and ask them to enable the SOAP extension for your account.
...
= 1.0.1 =
* Fixed PHP parse error in JavaScript code
* Added SOAP extension check during activation
* Improved error handling and admin notices
* Better compatibility with different hosting environments
* Fixed quote escaping issues in inline JavaScript
...
= 1.0.1 =
Important fix for plugin activation errors. Includes better SOAP extension checking and JavaScript fixes.
