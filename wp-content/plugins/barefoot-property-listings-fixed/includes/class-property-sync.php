...
class Barefoot_Property_Sync {
    ...
    public function sync_single_property($property_data) {
        try {
            ...
            if (empty($property_id) || empty($property_name)) {
                return array(
                    'success' => false,
                    'message' => 'Missing required property data (ID or Name)'
                );
            }
    ...
    private function prepare_property_meta($property_data) {
        $meta = array(
            ...
            '_barefoot_property_code' => $this->get_property_field($property_data, 'PropertyCode'),
            ...
            '_barefoot_max_guests' => $this->get_property_field($property_data, 'MaxGuests'),
            '_barefoot_square_feet' => $this->get_property_field($property_data, 'SquareFeet'),
            '_barefoot_address' => $this->get_property_field($property_data, 'Address'),
            '_barefoot_city' => $this->get_property_field($property_data, 'City'),
            '_barefoot_state' => $this->get_property_field($property_data, 'State'),
            '_barefoot_zip' => $this->get_property_field($property_data, 'ZipCode'),
            ...
            '_barefoot_price' => $this->get_property_field($property_data, 'BaseRate'),
            '_barefoot_min_stay' => $this->get_property_field($property_data, 'MinStay'),
            '_barefoot_max_stay' => $this->get_property_field($property_data, 'MaxStay'),
            '_barefoot_check_in' => $this->get_property_field($property_data, 'CheckIn'),
            '_barefoot_check_out' => $this->get_property_field($property_data, 'CheckOut'),
            '_barefoot_pets_allowed' => $this->get_property_field($property_data, 'PetsAllowed'),
            '_barefoot_smoking_allowed' => $this->get_property_field($property_data, 'SmokingAllowed'),
            ...
            '_barefoot_air_conditioning' => $this->get_property_field($property_data, 'AirConditioning'),
            '_barefoot_heating' => $this->get_property_field($property_data, 'Heating'),
            ...
            '_barefoot_washer_dryer' => $this->get_property_field($property_data, 'WasherDryer'),
            '_barefoot_tv_cable' => $this->get_property_field($property_data, 'TvCable'),
