...
class BarefootPropertyListings {
    ...
    private function init_hooks() {
        ...
        // AJAX hooks (only if SOAP is available)
        if (extension_loaded('soap')) {
    ...
    private function init_admin() {
        if (class_exists('Barefoot_Admin_Page')) {
    ...
    public function enqueue_frontend_assets() {
        ...
        wp_add_inline_style('barefoot-frontend', $this->get_frontend_css());
        wp_add_inline_script('jquery', $this->get_frontend_js());
    }
    
    public function enqueue_admin_assets() {
        // Admin inline styles and scripts
    ...
    public function activate() {
        ...
        if (version_compare(PHP_VERSION, '7.4', '<')) {
            ...
            wp_die(__('Barefoot Property Listings requires PHP 7.4 or higher.', 'barefoot-properties'));
        }
        
        // Check SOAP extension
        if (!extension_loaded('soap')) {
            deactivate_plugins(plugin_basename(__FILE__));
            wp_die(__('Barefoot Property Listings requires the PHP SOAP extension. Please contact your hosting provider.', 'barefoot-properties'));
        }
